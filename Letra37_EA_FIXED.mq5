...
input double        InpOwnerTransferThresh = 80.0;      // Ownership transfer %: the opposing curve must dominate by at least this % to confirm transfer (raised from 65% → math shows 80-85% avoids pullback noise on gold trends)
